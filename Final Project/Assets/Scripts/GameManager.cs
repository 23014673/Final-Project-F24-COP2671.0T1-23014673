...
public class GameManager : MonoBehaviour
{
    ...
    {   
        ...
        int finalMinutes = Mathf.FloorToInt(timer / 60);

        int finalSeconds = Mathf.FloorToInt(timer % 60);
    
        Debug.Log("Record time:  " + string.Format("{0:00}:{1:00}", finalMinutes, finalSeconds));
